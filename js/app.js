...
(function () {
  ...
  function applyConfig(cfg) {
    ...
    const keyToChk = {
      ...
      address: 'chk-address', addressCtx: 'chk-address', addressInline: 'chk-address', postcode: 'chk-address',
  ...
  $('btn-preset-medico').addEventListener('click', () => applyConfig({
    ...
    enabled: {
      ...
      address: true, addressCtx: true, addressInline: true, postcode: false, birthdate: true, birthdateText: true,
  ...
  $('btn-preset-juridico').addEventListener('click', () => applyConfig({
    ...
    enabled: {
      ...
      address: true, addressCtx: true, addressInline: true, postcode: true, birthdate: true, birthdateText: true,
  ...
  function getOptions() {
    ...
    const enabled = {
      ...
      nif:            $('chk-dni').checked,
      nit:            $('chk-dni').checked,
      cedula:         $('chk-dni').checked,
      cuil:           $('chk-cuil').checked,
      rfc:            $('chk-rfc').checked,
      rut:            $('chk-rut').checked,
      rutLong:        $('chk-rut').checked,
      ...
      addressInline:  $('chk-address').checked,
